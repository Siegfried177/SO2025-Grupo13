...
# TP 1 -- LFS
## Descripción
Construcción de un sistema Linux mínimo desde cero, siguiendo el manual oficial de Linux From Scratch y utilizando systemd como sistema de inicialización.
...
# TP 2 -- SHELL
## Descripción
Implementación de un Shell básico con comandos propios, control de versiones y documentación técnica. El sistema debe ser funcional, probado y registrado en un diario de construcción.
